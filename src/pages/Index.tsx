          ...
          <div className="grid md:grid-cols-2 gap-12 py-16 px-6 md:px-12">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
                <span className="text-gradient-primary">Challenge</span> your
                mind with daily word puzzles
              </h1>

              <p className="text-muted-foreground text-lg">
                Engage your brain with our beautifully crafted word search
                puzzles. Find hidden words, earn points, and track your
                progress.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <Link to="/archive">Explore Past Challenges</Link>
                </Button>
              </div>
            </motion.div>
        ...
        <section className="py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              WordWonder combines classic word search with modern design and
              engaging challenges
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center mb-4 ${feature.iconBg}`}
                >
            ...
            <div className="relative py-12 px-6 md:px-12 text-white">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-white/80 text-lg mb-8">
                  A new word puzzle is waiting for you. Challenge yourself and
                  see how quickly you can find all the hidden words!
                </p>
...
const features = [
  {
    ...
    description:
      "Search for words horizontally, vertically, diagonally, forwards and backwards. Select all letters, then click the first letter again to confirm.",
    icon: Sparkles,
  ...
  },
  {
    ...
    description:
      "A new puzzle every day to keep your mind sharp. Track your streak and compare your times.",
    icon: Calendar,
  ...
  },
  {
    ...
    description:
      "Stuck on a tough word? Use hints wisely to reveal letters or get a clue about the word's meaning.",
    icon: Lightbulb,
